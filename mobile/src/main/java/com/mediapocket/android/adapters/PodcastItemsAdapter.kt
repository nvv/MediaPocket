 ...
 */
class PodcastItemsAdapter(val items: List<Item>?,
                          val parentLink: String,
                          private val podcastId: String?) : RecyclerView.Adapter<PodcastItemsAdapter.PodcastItemViewHolder>() {

    private val data = mutableListOf<PodcastItem>()
    private val dataMap = LinkedHashMap<String, PodcastItem>()
...
//    private var records: List<PodcastDownloadItem>? = null
    ...
    init {
        ...
        items?.forEachIndexed { index, it ->
            val newItem = PodcastItem(index, it)
            data.add(newItem)
    ...
    inner class PodcastItemViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(item: PodcastItem, payloads: List<Any>? = null) {
            ...
            status.setOnClickListener {
                DependencyLocator.getInstance().podcastDownloadManager.download(podcastId, item.item)
    ...
    inner class PodcastItem(val position: Int, val item: Item) {
